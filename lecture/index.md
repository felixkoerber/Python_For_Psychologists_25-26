...
In case you have any questions or difficulties with the lecture and its materials, please don’t hesitate a single second to get in touch with us. A great way to do this is to open an issue on the GitHub site of the course. You can of course further contact me via [E-mail](kallmayer@psych.uni-frankfurt.de). Every feedback or idea  you might have is highly appreciated and valued. Please remember that this year over 27 people have joined this course and while I will do my best to get back to everyone in a timely manner, please be understanding if I don't and feel free to send me another reminder email or approach me after class.
...
This course was initially composed and designed by [Peer Herholz](https://github.com/PeerHerholz) and adapted for this semester by Aylin Kallmayer.
